...
ifneq (,$(snake_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f snake.make config=$(snake_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f snake.make clean
